...
/***/ "./packages/theme/src/resources/js/_checkAuth.js":
/*!*******************************************************!*\
  !*** ./packages/theme/src/resources/js/_checkAuth.js ***!
  \*******************************************************/
/*! no static exports found */
  ...
  if (!window.checkLogin) {
    var checkLogin = function checkLogin() {
      ...
      fetch(uri, {
        ...
        document.querySelector('#header .signin').textContent = data.data.fullname || data.data.email;
        document.querySelector('#header .register-button-text').textContent = "Tới trang Dashboard";
      })["catch"](function (error) {
        document.querySelector('#header .signin').textContent = 'Đăng nhập';
        document.querySelector('#header .register-button-text').textContent = "Đăng ký dùng thử";
      });
    };

    try {
      if (document.querySelector('#header .signin') && document.querySelector('#header .register-button-text')) checkLogin();
    } catch (error) {
      console.warn(error);
    }
  }
...
document.addEventListener('DOMContentLoaded', function (ev) {
  ...
  var CPU_VALUE = [1, 2, 3, 4, 6, 8, 12, 16, 24, 32, 40, 48, 56, 64, 96];
  var RAM_VALUE = [1, 2, 3, 4, 6, 8, 10, 12, 16, 24, 32, 48, 64, 96, 128, 192, 256, 512];
  ...
  var DATA_DISK_SIZE_VALUE = [].concat(ROOT_DISK_SIZE_VALUE);
  ...
  function createSlider() {
    ...
    sliderElement.noUiSlider.on('update', function (value) {
      ...
      updateInputValue($('.input-rang-value.' + id), nextValue.value);

      if (document.querySelector('.input-rang-value.' + id)) {
        document.querySelector('.input-rang-value.' + id).removeEventListener("change", onInputChange);
        document.querySelector('.input-rang-value.' + id).addEventListener("change", onInputChange);
      }
  ...
  function getNextId(arrayItem, prefix) {
    ...
    for (var _i = 1; _i <= arrayItem.length + 1 || 100; _i++) {
      if (blackList.indexOf(_i) === -1) return prefix + _i;
    }
  ...
  function renderDataDisk(panel) {
    ...
    var addInput = function addInput(p, item) {
      var dom = '<div class="form-group"><div class="bf-row"><div class="bf-col-auto col-input"><div class="input-range">';
      ...
      dom += '<input class="input-rang-value idatadisk ' + item.id + '" value="' + item.size + '">';
  ...
  function updateDataDiskValue(payload, data, isupdateInput) {
    if (!data) return;
  ...
  function updateInputValue(el, data) {
    if (el) el.val(data);
  }

  function onInputChange(event) {
    event.stopPropagation();
    var id = getSlideIdByInputClassList(event.target.classList);
    if (!id) return;
    var arrItemIndex = getArrayById(id);
    var indexValue = getValueIndex(event.target.value, arrItemIndex);
    slide = document.getElementById(id);
    if (!slide) return;
    slide.noUiSlider.set(indexValue);
    console.log('el onchange ', event);
  }

  function getArrayById(_id) {
    var ls = [{
      value: 'cpu',
      arr: CPU_VALUE
    }, {
      ...
      value: 'disk',
      arr: ROOT_DISK_SIZE_VALUE
    }];
    var result = [];
    ls.forEach(function (item) {
      if (_id.indexOf(item.value) !== -1) {
        result = item.arr;
        return false;
      }
    });
  ...
  function getValueIndex(inputVal, arr) {
    var value = inputVal;

    if (parseInt(inputVal) > arr[arr.length - 1]) {
      return arr.length - 1;
    }
  ...
  function getSlideIdByInputClassList(classList) {
    var id = null;
    var frefixDataId = 'data_disk';
    var ids = ['fcpu', 'fram', 'frootdisksize'];
    ...
    classList.forEach(function (item) {
      if (item.indexOf(frefixDataId) !== -1) {
        id = item;
        return false;
      }
    });
...
/***/ "./packages/theme/src/resources/js/_common.js":
/*!****************************************************!*\
  !*** ./packages/theme/src/resources/js/_common.js ***!
  \****************************************************/
/*! no static exports found */
...
/***/ "./packages/theme/src/resources/js/_readmore.js":
/*!******************************************************!*\
  !*** ./packages/theme/src/resources/js/_readmore.js ***!
  \******************************************************/
/*! no static exports found */
...
var tgr = $('.show-toggle-readmore');
tgr.length > 0 && tgr.each(function (index, el) {
  var classHiden = 'd-none';
  var classReadmore = 'readmore';
  var labelReadmore = 'Xem thêm';
  var labelReadless = 'Thu gọn';
  var readmore = $(this).find('.' + classReadmore);
  var count = 8;
  if ($(this).find('li').length <= count) return;
  $(this).find('li').each(function (index) {
    if (index >= count) {
      $(this).addClass(classHiden);
    }
  });

  if (readmore.length === 0) {
    $(this).append('<div class="' + classReadmore + '">' + labelReadmore + '</div>');
    readmore = $(this).find('.' + classReadmore);
  }

  function toggleReadmore() {
    var ls = $(this).closest('ul').first();

    if (ls.find('.' + classHiden).length > 0) {
      ls.find('.' + classHiden).removeClass(classHiden);
      $(this).text(labelReadless);
    } else {
      ls.find('li').each(function (index) {
        if (index >= count) {
          $(this).addClass(classHiden);
        }
      });
      $(this).text(labelReadmore);
    }
  }
...
/***/ "./packages/theme/src/resources/js/_scrollingNumber.js":
/*!*************************************************************!*\
  !*** ./packages/theme/src/resources/js/_scrollingNumber.js ***!
  \*************************************************************/
/*! no static exports found */
...
function initScroll() {
  if (isScrolledIntoView($(".scrolling-numbers")) && !viewed) {
    viewed = true;
    $('.value').each(function () {
      $(this).prop('Counter', 0).animate({
        ...
        step: function step(now) {
          var formatedNumber = Math.ceil(now).toLocaleString(undefined, {
            minimumFractionDigits: 0
          });
          $(this).text(formatedNumber);
        }
      });
    });
  }
...
$(function () {
  var sliderPricing = $('.slide_pricing').owlCarousel;
  if (sliderPricing) $('.slide_pricing').owlCarousel({
    loop: true,
    margin: 0,
    nav: true,
    dots: false,
...
$(function () {
  var sliderPartners = $('.slider_partners').owlCarousel;
  if (sliderPartners) $('.slider_partners').owlCarousel({
    loop: true,
    margin: 0,
    nav: true,
    dots: false,
...
$(function () {
  var sliderSingle = $('.slider_single').owlCarousel;
  if (sliderSingle) $('.slider_single').owlCarousel({
    loop: true,
    margin: 0,
    nav: true,
    items: 1
...
__webpack_require__(/*! ./_common */ "./packages/theme/src/resources/js/_common.js");

__webpack_require__(/*! ./_readmore */ "./packages/theme/src/resources/js/_readmore.js");
...
__webpack_require__(/*! ./_checkAuth */ "./packages/theme/src/resources/js/_checkAuth.js");

__webpack_require__(/*! ./_scrollingNumber */ "./packages/theme/src/resources/js/_scrollingNumber.js");
...
/***/ "./packages/theme/src/resources/sass/pages/cloud-watcher_page.scss":
/*!*************************************************************************!*\
  !*** ./packages/theme/src/resources/sass/pages/cloud-watcher_page.scss ***!
  \*************************************************************************/
/*! no static exports found */
...
/***/ "./packages/theme/src/resources/sass/pages/common_page.scss":
/*!******************************************************************!*\
  !*** ./packages/theme/src/resources/sass/pages/common_page.scss ***!
  \******************************************************************/
/*! no static exports found */
...
/***/ "./packages/theme/src/resources/sass/pages/techblog_page.scss":
/*!********************************************************************!*\
  !*** ./packages/theme/src/resources/sass/pages/techblog_page.scss ***!
  \********************************************************************/
/*! no static exports found */
...
/***/ "./packages/theme/src/resources/sass/pages/toeic_page.scss":
/*!*****************************************************************!*\
  !*** ./packages/theme/src/resources/sass/pages/toeic_page.scss ***!
  \*****************************************************************/
/*! no static exports found */
...
/***/ 0:
/*!*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** multi ./packages/theme/src/resources/js/app.js ./packages/theme/src/resources/sass/app.scss ./packages/theme/src/resources/sass/theme.scss ./packages/theme/src/resources/sass/pages/elements_layout.scss ./packages/theme/src/resources/sass/pages/common_page.scss ./packages/theme/src/resources/sass/pages/cdn_page.scss ./packages/theme/src/resources/sass/pages/cloud-watcher_page.scss ./packages/theme/src/resources/sass/pages/techblog_page.scss ./packages/theme/src/resources/sass/pages/toeic_page.scss ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! D:\VCCLOUD\HOMEBIZFLYCLOUD\HOMEPAGE_V2\homepage_v3\packages\theme\src\resources\js\app.js */"./packages/theme/src/resources/js/app.js");
__webpack_require__(/*! D:\VCCLOUD\HOMEBIZFLYCLOUD\HOMEPAGE_V2\homepage_v3\packages\theme\src\resources\sass\app.scss */"./packages/theme/src/resources/sass/app.scss");
__webpack_require__(/*! D:\VCCLOUD\HOMEBIZFLYCLOUD\HOMEPAGE_V2\homepage_v3\packages\theme\src\resources\sass\theme.scss */"./packages/theme/src/resources/sass/theme.scss");
__webpack_require__(/*! D:\VCCLOUD\HOMEBIZFLYCLOUD\HOMEPAGE_V2\homepage_v3\packages\theme\src\resources\sass\pages\elements_layout.scss */"./packages/theme/src/resources/sass/pages/elements_layout.scss");
__webpack_require__(/*! D:\VCCLOUD\HOMEBIZFLYCLOUD\HOMEPAGE_V2\homepage_v3\packages\theme\src\resources\sass\pages\common_page.scss */"./packages/theme/src/resources/sass/pages/common_page.scss");
__webpack_require__(/*! D:\VCCLOUD\HOMEBIZFLYCLOUD\HOMEPAGE_V2\homepage_v3\packages\theme\src\resources\sass\pages\cdn_page.scss */"./packages/theme/src/resources/sass/pages/cdn_page.scss");
__webpack_require__(/*! D:\VCCLOUD\HOMEBIZFLYCLOUD\HOMEPAGE_V2\homepage_v3\packages\theme\src\resources\sass\pages\cloud-watcher_page.scss */"./packages/theme/src/resources/sass/pages/cloud-watcher_page.scss");
__webpack_require__(/*! D:\VCCLOUD\HOMEBIZFLYCLOUD\HOMEPAGE_V2\homepage_v3\packages\theme\src\resources\sass\pages\techblog_page.scss */"./packages/theme/src/resources/sass/pages/techblog_page.scss");
module.exports = __webpack_require__(/*! D:\VCCLOUD\HOMEBIZFLYCLOUD\HOMEPAGE_V2\homepage_v3\packages\theme\src\resources\sass\pages\toeic_page.scss */"./packages/theme/src/resources/sass/pages/toeic_page.scss");
