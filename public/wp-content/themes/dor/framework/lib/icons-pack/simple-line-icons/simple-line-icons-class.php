...
if ( ! function_exists( 'dor_mikado_add_simple_line_icon_pack' ) ) {
	function dor_mikado_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new DorMikadoClassSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'dor_mikado_filter_add_icon_pack_into_collection', 'dor_mikado_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'dor_mikado_add_simple_line_icon_pack_option' ) ) {
	function dor_mikado_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'dor' );
		
		return $options;
	}
	
	add_filter( 'dor_mikado_filter_add_icon_pack_into_options', 'dor_mikado_add_simple_line_icon_pack_option' );
	add_filter( 'dor_mikado_filter_add_icon_pack_into_social_options', 'dor_mikado_add_simple_line_icon_pack_option' );
}

class DorMikadoClassSimpleLineIcons implements iDorMikadoInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'dor'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'dor'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'dor'),
            'icon-social-facebook'    => esc_html__('Facebook', 'dor'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'dor'),
            'icon-social-github'      => esc_html__('Github', 'dor'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'dor'),
            'icon-social-instagram'   => esc_html__('Instagram', 'dor'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'dor'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'dor'),
            'icon-social-reddit'      => esc_html__('Reddit', 'dor'),
            'icon-social-skype'       => esc_html__('Skype', 'dor'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'dor'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'dor'),
            'icon-social-spotify'     => esc_html__('Spotify', 'dor'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'dor'),
            'icon-social-twitter'     => esc_html__('Twitter', 'dor'),
            'icon-social-youtube'     => esc_html__('Youtube', 'dor')
        );
    }
