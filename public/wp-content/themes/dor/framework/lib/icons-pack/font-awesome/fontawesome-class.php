...
if ( ! function_exists( 'dor_mikado_add_font_awesome_icon_pack' ) ) {
	function dor_mikado_add_font_awesome_icon_pack( $iconCollections ) {
		$iconCollections['font_awesome'] = new DorMikadoClassIconsFontAwesome( 'Font Awesome', 'fa_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'dor_mikado_filter_add_icon_pack_into_collection', 'dor_mikado_add_font_awesome_icon_pack' );
}

if ( ! function_exists( 'dor_mikado_add_font_awesome_icon_pack_option' ) ) {
	function dor_mikado_add_font_awesome_icon_pack_option( $options ) {
		$options['font_awesome'] = esc_html__( 'Font Awesome', 'dor' );
		
		return $options;
	}
	
	add_filter( 'dor_mikado_filter_add_icon_pack_into_options', 'dor_mikado_add_font_awesome_icon_pack_option' );
	add_filter( 'dor_mikado_filter_add_icon_pack_into_social_options', 'dor_mikado_add_font_awesome_icon_pack_option' );
}

class DorMikadoClassIconsFontAwesome implements iDorMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
