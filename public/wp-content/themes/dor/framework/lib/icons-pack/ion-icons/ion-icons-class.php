...
if ( ! function_exists( 'dor_mikado_add_ion_icon_pack' ) ) {
	function dor_mikado_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new DorMikadoClassIonIcons( 'Ion Icons', 'ion_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'dor_mikado_filter_add_icon_pack_into_collection', 'dor_mikado_add_ion_icon_pack' );
}

if ( ! function_exists( 'dor_mikado_add_ion_icon_pack_option' ) ) {
	function dor_mikado_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'dor' );
		
		return $options;
	}
	
	add_filter( 'dor_mikado_filter_add_icon_pack_into_options', 'dor_mikado_add_ion_icon_pack_option' );
	add_filter( 'dor_mikado_filter_add_icon_pack_into_social_options', 'dor_mikado_add_ion_icon_pack_option' );
}

class DorMikadoClassIonIcons implements iDorMikadoInterfaceIconCollection {
	public $icons;
	public $socialIcons;
    public $title;
	public $param;
