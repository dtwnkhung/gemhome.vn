...
if ( ! function_exists( 'dor_mikado_add_linea_icon_pack' ) ) {
	function dor_mikado_add_linea_icon_pack( $iconCollections ) {
		$iconCollections['linea_icons'] = new DorMikadoClassLineaIcons( 'Linea Icons', 'linea_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'dor_mikado_filter_add_icon_pack_into_collection', 'dor_mikado_add_linea_icon_pack' );
}

if ( ! function_exists( 'dor_mikado_add_linea_icon_pack_option' ) ) {
	function dor_mikado_add_linea_icon_pack_option( $options ) {
		$options['linea_icons'] = esc_html__( 'Linea Icons', 'dor' );
		
		return $options;
	}
	
	add_filter( 'dor_mikado_filter_add_icon_pack_into_options', 'dor_mikado_add_linea_icon_pack_option' );
}

class DorMikadoClassLineaIcons implements iDorMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
