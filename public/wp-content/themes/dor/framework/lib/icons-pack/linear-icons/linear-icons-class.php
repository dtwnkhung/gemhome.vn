...
if ( ! function_exists( 'dor_mikado_add_linear_icon_pack' ) ) {
	function dor_mikado_add_linear_icon_pack( $iconCollections ) {
		$iconCollections['linear_icons'] = new DorMikadoClassLinearIcons( 'Linear Icons', 'linear_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'dor_mikado_filter_add_icon_pack_into_collection', 'dor_mikado_add_linear_icon_pack' );
}

if ( ! function_exists( 'dor_mikado_add_linear_icon_pack_option' ) ) {
	function dor_mikado_add_linear_icon_pack_option( $options ) {
		$options['linear_icons'] = esc_html__( 'Linear Icons', 'dor' );
		
		return $options;
	}
	
	add_filter( 'dor_mikado_filter_add_icon_pack_into_options', 'dor_mikado_add_linear_icon_pack_option' );
}

class DorMikadoClassLinearIcons implements iDorMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
