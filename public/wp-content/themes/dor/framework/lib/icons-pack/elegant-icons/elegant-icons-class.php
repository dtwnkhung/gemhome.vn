...
if ( ! function_exists( 'dor_mikado_add_font_elegant_icon_pack' ) ) {
	function dor_mikado_add_font_elegant_icon_pack( $iconCollections ) {
		$iconCollections['font_elegant'] = new DorMikadoClassIconsFontElegant( 'Font Elegant', 'fe_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'dor_mikado_filter_add_icon_pack_into_collection', 'dor_mikado_add_font_elegant_icon_pack' );
}

if ( ! function_exists( 'dor_mikado_add_font_elegant_icon_pack_option' ) ) {
	function dor_mikado_add_font_elegant_icon_pack_option( $options ) {
		$options['font_elegant'] = esc_html__( 'Font Elegant', 'dor' );
		
		return $options;
	}
	
	add_filter( 'dor_mikado_filter_add_icon_pack_into_options', 'dor_mikado_add_font_elegant_icon_pack_option' );
	add_filter( 'dor_mikado_filter_add_icon_pack_into_social_options', 'dor_mikado_add_font_elegant_icon_pack_option' );
}

class DorMikadoClassIconsFontElegant implements iDorMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
