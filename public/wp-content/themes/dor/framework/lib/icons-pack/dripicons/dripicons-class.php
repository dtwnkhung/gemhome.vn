...
if ( ! function_exists( 'dor_mikado_add_dripicons_icon_pack' ) ) {
	function dor_mikado_add_dripicons_icon_pack( $iconCollections ) {
		$iconCollections['dripicons'] = new DorMikadoClassDripicons( 'Dripicons', 'dripicon' );
		
		return $iconCollections;
	}
	
	add_filter( 'dor_mikado_filter_add_icon_pack_into_collection', 'dor_mikado_add_dripicons_icon_pack' );
}

if ( ! function_exists( 'dor_mikado_add_dripicons_icon_pack_option' ) ) {
	function dor_mikado_add_dripicons_icon_pack_option( $options ) {
		$options['dripicons'] = esc_html__( 'Dripicons', 'dor' );
		
		return $options;
	}
	
	add_filter( 'dor_mikado_filter_add_icon_pack_into_options', 'dor_mikado_add_dripicons_icon_pack_option' );
}

class DorMikadoClassDripicons implements iDorMikadoInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
