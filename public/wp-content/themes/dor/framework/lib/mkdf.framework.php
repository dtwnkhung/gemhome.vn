...
class DorMikadoClassFramework {
	...
	private function __construct() {
		$this->mkdOptions         = DorMikadoClassOptions::get_instance();
		$this->mkdMetaBoxes       = DorMikadoClassMetaBoxes::get_instance();
		$this->mkdTaxonomyOptions = DorMikadoClassTaxonomyOptions::get_instance();
		$this->mkdUserOptions     = DorMikadoClassUserOptions::get_instance();
		$this->mkdDashboardOptions = DorMikadoClassDashboardOptions::get_instance();
	}
	...
	public function setSkin( DorMikadoClassSkinAbstract $skinObject ) {
		$this->skin = $skinObject;
	}
}

/**
 * Class DorMikadoClassSkinManager
 *
...
class DorMikadoClassSkinManager {
	...
	/**
	 * @see DorMikadoClassSkinManager::setSkin()
	 */
...
/**
 * Class DorMikadoClassSkinAbstract
 *
 * Abstract class that each skin class must extend
 */
abstract class DorMikadoClassSkinAbstract {
	/**
	 * @var string
	 */
	protected $skinName;
	...
	public function loadTemplatePart( $template, $params = array() ) {
		...
		if ( $template !== '' ) {
			include( dor_mikado_find_template_path( 'framework/admin/skins/' . $this->skinName . '/templates/' . $template . '.php' ) );
		}
	}
	...
	public function setShortcodeJSParams() { ?>
		<script>
			window.mkdSCIcon = '<?php echo dor_mikado_get_skin_uri() . '/assets/img/admin-logo-icon.png'; ?>';
			window.mkdSCLabel = '<?php echo esc_html( ucfirst( $this->skinName ) ); ?> <?php esc_html_e( 'Shortcodes', 'dor' ) ?>';
		</script>
	<?php }
...
class DorMikadoClassOptions {
	...
	public function getOptionValue( $key ) {
		...
		if ( array_key_exists( $key, $dor_mikado_global_options ) ) {
			return $dor_mikado_global_options[ $key ];
...
/*
   Class: DorMikadoClassAdminPage
   A class that initializes Mikado Admin Page
*/
class DorMikadoClassAdminPage implements iDorMikadoInterfaceLayoutNode {
	public $layout;
	private $factory;
	public $slug;
	public $title;
	...
	function __construct( $slug = "", $title = "", $icon = "" ) {
		$this->layout  = array();
		$this->factory = new DorMikadoClassFieldFactory();
		$this->slug    = $slug;
		$this->title   = $title;
		$this->icon    = $icon;
	}
	...
	public function renderChild( iDorMikadoInterfaceRender $child ) {
		$child->render( $this->factory );
	}
}

/*
   Class: DorMikadoClassMetaBoxes
...
/*
   Class: DorMikadoClassMetaBox
   A class that initializes Mikado Meta Box
*/
class DorMikadoClassMetaBox implements iDorMikadoInterfaceLayoutNode {
	public $layout;
	private $factory;
	public $scope;
	public $title;
	...
	public function setTitle( $label ) {
		...
		return $dor_mikado_global_Framework->getSkin()->getSkinLabel() . ' ' . $label;
	}
}

/*
   Class: DorMikadoClassTaxonomyOptions
   A class that initializes DorMikadoClass Taxonomy Options
*/
class DorMikadoClassTaxonomyOptions {
	private static $instance;
...
/*
   Class: DorMikadoClassTaxonomyOption
   A class that initializes DorMikadoClass Taxonomy Option
*/
class DorMikadoClassTaxonomyOption implements iDorMikadoInterfaceLayoutNode {
	public $layout;
	private $factory;
	public $scope;
	...
	function __construct( $scope = "" ) {
		$this->layout  = array();
		$this->factory = new DorMikadoClassTaxonomyFieldFactory();
		$this->scope   = $scope;
	}
...
/*
   Class: DorMikadoClassUserOptions
   A class that initializes DorMikadoClass User Options
*/
class DorMikadoClassUserOptions {
	private static $instance;
	public $userOptions;
...
/*
   Class: DorMikadoClassUserOption
   A class that initializes DorMikadoClass User Option
*/
class DorMikadoClassUserOption implements iDorMikadoInterfaceLayoutNode {
	public $layout;
	private $factory;
	public $scope;
	...
	function __construct( $scope = "" ) {
		$this->layout  = array();
		$this->factory = new DorMikadoClassUserFieldFactory();
		$this->scope   = $scope;
	}
...
/*
   Class: DorMikadoClassDashboardOptions
   A class that initializes DorMikadoClass Dashboard Options
*/
class DorMikadoClassDashboardOptions {
	private static $instance;
...
/*
   Class: DorMikadoClassDashboardOption
   A class that initializes DorMikadoClass Dashboard Option
*/
class DorMikadoClassDashboardOption implements iDorMikadoInterfaceLayoutNode {
	public $layout;
	private $factory;
	
	function __construct() {
		$this->layout        = array();
		$this->factory       = new DorMikadoClassDashboardFieldFactory();
	}
...
if ( ! function_exists( 'dor_mikado_init_framework_variable' ) ) {
	function dor_mikado_init_framework_variable() {
		global $dor_mikado_global_Framework;
		
		$dor_mikado_global_Framework = DorMikadoClassFramework::get_instance();
		$mkdSkinManager                 = new DorMikadoClassSkinManager();
		$dor_mikado_global_Framework->setSkin( $mkdSkinManager->getSkin() );
	}
	
	add_action( 'dor_mikado_action_before_options_map', 'dor_mikado_init_framework_variable' );
}
?>