...
<div class="mkdf-title-holder <?php echo esc_attr($holder_classes); ?>" <?php dor_mikado_inline_style($holder_styles); ?> <?php echo dor_mikado_get_inline_attrs($holder_data); ?>>
	...
	<div class="mkdf-title-wrapper" <?php dor_mikado_inline_style($wrapper_styles); ?>>
		<div class="mkdf-title-inner">
			<div class="mkdf-grid">
				<?php if(!empty($title)) { ?>
					<<?php echo esc_attr($title_tag); ?> class="mkdf-page-title entry-title" <?php dor_mikado_inline_style($title_styles); ?>><?php echo esc_html($title); ?></<?php echo esc_attr($title_tag); ?>>
				<?php } ?>
				<?php if(!empty($subtitle)){ ?>
					<<?php echo esc_attr($subtitle_tag); ?> class="mkdf-page-subtitle" <?php dor_mikado_inline_style($subtitle_styles); ?>><?php echo esc_html($subtitle); ?></<?php echo esc_attr($subtitle_tag); ?>>
				<?php } ?>
			</div>
	    </div>
	</div>
