...
class PartnerController extends Controller
{
    public function __construct()
    {
        ...
        $this->label = 'partner';
        $this->router = 'partner';
        $this->template_folder = 'admin.partners';
    ...
    public function updateAttrs($request, $slug = Null)
    {
        ...
        if (isset($request->image_1) && !is_null($request->image_1)) {
            $image_1 = $request->image_1->store($this->table);
        } else if(isset($request->image_1_src) && !is_null($request->image_1_src)) {
            $image_1 = $request->image_1_src;
        }
        $attrs = [
            'slug' => $newSlug,
            'title' => $request->title,
