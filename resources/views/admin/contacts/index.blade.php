                ...
                <table class="dataTable table table-responsive-sm table-hover table-outline mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-success btn-sm" href="{{ route($controller_router . '.edit', $category->id) }}">
                                    <i class="fa fa-edit"></i>
                                </a>
                                <form action="{{ route($controller_router . '.destroy', $category->id) }}" method="POST" style="display:inline-block">
                                    @csrf
                                    @method('DELETE')
