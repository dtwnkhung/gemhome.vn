...
<head>
	...
	<title>{{ __('auth.Register') }} - {{ config('app.name', 'App') }}</title>
				...
				<div class="col-md-6 col-12 fxt-bg-color">
					<div class="fxt-content">
						...
						<div class="fxt-form">
							...
							<p>{{ __('auth.Register to continue in our website') }}</p>
								...
								<div class="form-group">
									<div class="fxt-transformY-50 fxt-transition-delay-3">
										<div class="fxt-content-between">
											<button type="submit" class="fxt-btn-fill">{{ __('auth.Register') }}</button>
