              ...
              <div class="mkdf-position-left">
                <div class="mkdf-position-left-inner">
                  ...
                  <nav class="mkdf-main-menu mkdf-drop-down mkdf-sticky-nav">
                    <ul id="menu-main-menu-1" class="clearfix" data-menu="{{ !!is_null(Route::current()) ? false : Route::current()->getName() . \Request::path() }}">
                      <li id="sticky-nav-menu-item-18"
                        class="@if(\Request::path() == 'index.html') active @endif menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children mkdf-active-item has_sub narrow">
                        <a href="/index.html" class=" current "><span class="item_outer"><span class="item_text">Trang
                              chủ</span><span class="plus"></span><i
                              class="mkdf-menu-arrow fa fa-angle-down"></i></span></a>
                      </li>
                      <li id="sticky-nav-menu-item-19"
                        class="@if(!!is_null(Route::current()) ? false : Route::current()->getName() == 'about-us.html') active @endif menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children  has_sub narrow">
                        <a href="/about-us.html" class=""><span class="item_outer"><span class="item_text">Giới
                              thiệu</span><span class="plus"></span><i
                              class="mkdf-menu-arrow fa fa-angle-down"></i></span></a>
                      </li>
                      <li id="sticky-nav-menu-item-19"
                        class="@if(\Request::path() == 'thu-vien.html') active @endif menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children  has_sub narrow">
                        <a href="/thu-vien.html" class=""><span class="item_outer"><span class="item_text">Thư
                              viện</span><span class="plus"></span><i
                              class="mkdf-menu-arrow fa fa-angle-down"></i></span></a>
                      </li>
                      <li id="sticky-nav-menu-item-20"
                        class="@if(\Request::path() == 'du-an.html') active @endif menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children  has_sub wide">
                        <a href="/du-an.html" class=""><span class="item_outer"><span class="item_text">Dự
                              án</span><span class="plus"></span><i
                              class="mkdf-menu-arrow fa fa-angle-down"></i></span></a>
                      </li>
                      <li id="sticky-nav-menu-item-21"
                        class="@if(\Request::path() == 'tin-tuc.html') active @endif menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children  has_sub narrow">
                        <a href="/tin-tuc.html" class=""><span class="item_outer"><span class="item_text">Tin
                              tức</span><span class="plus"></span><i
                              class="mkdf-menu-arrow fa fa-angle-down"></i></span></a>
                      </li>
                      <li id="sticky-nav-menu-item-22"
                        class="@if(\Request::path() == 'contact-us.html') active @endif menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children  has_sub narrow">
                        <a href="/contact-us.html" class=""><span class="item_outer"><span class="item_text">Liên
                              hệ</span><span class="plus"></span><i
                              class="mkdf-menu-arrow fa fa-angle-down"></i></span></a>
                      </li>
                    </ul>
                  </nav>
      ...
      <header class="mkdf-mobile-header">
        <div class="mkdf-mobile-header-inner">
          ...
          <nav class="mkdf-mobile-nav" aria-label="Mobile Menu">
            <div class="mkdf-grid">
            <ul id="menu-main-menu-2" class="clearfix" data-menu="{{ !!is_null(Route::current()) ? false : Route::current()->getName() . \Request::path() }}">
                      <li id="sticky-nav-menu-item-18"
                        class="@if(\Request::path() == 'index.html') active @endif menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children mkdf-active-item has_sub narrow">
                        <a href="/index.html" class=" current "><span class="item_outer"><span class="item_text">Trang
                              chủ</span><span class="plus"></span><i
...
/* ]]> */
  ...
  <style>
    .mkdf-logo-wrapper.mkdf-text-logo .mkdf-text-logo-left-wrap .mkdf-text-logo-left {
      ...
      width: 101px;
      height: 50px;
      background: transparent url(/wp-content/uploads/2019/03/logo_apex.png) no-repeat center top / 100% 100%;
    }
