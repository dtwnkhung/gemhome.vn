				...
				<div class="col-md-6 col-12 fxt-bg-color">
					<div class="fxt-content">
						...
						<div class="fxt-form">
							...
							<form method="POST" action="{{ route('appuser.password.update') }}">
                                @csrf
        
                                <input type="hidden" name="token" value="{{ $token }}">
        
                                <div class="form-group row">
                                    <label for="email" class="col-md-12 col-form-label text-md-left">{{ __('app.Email') }}</label>
                                ...
                                <div class="form-group row">
                                    <label for="password" class="col-md-12 col-form-label text-md-left">{{ __('app.New Password') }}</label>
                                ...
                                <div class="form-group row">
                                    <label for="password-confirm" class="col-md-12 col-form-label text-md-left">{{ __('app.Confirm New Password') }}</label>
